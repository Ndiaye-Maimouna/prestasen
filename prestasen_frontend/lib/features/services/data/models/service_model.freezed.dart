...
class _$ServiceModelImpl implements _ServiceModel {
  ...
  @override
  String toString() {
    return 'ServiceModel(id: $id, professionnelId: $professionnelId, professionnelNom: $professionnelNom, titre: $titre, description: $description, categorieNom: $categorieNom, prixIndicatif: $prixIndicatif, images: $images, actif: $actif, dateCreation: $dateCreation)';
  }
